...
import CryptoHeatMap from 'src/modules/_old/app-center/CryptoHeatMap';
import LatestTransaction from 'src/modules/_old/app-center/LatestTransaction';
import MostVisitedContract from 'src/modules/_old/app-center/MostVisitedContract';
import TopTokens from 'src/modules/_old/app-center/TopTokens';
import TransactionDappHistory from 'src/modules/_old/app-center/TransactionDappHistory';
